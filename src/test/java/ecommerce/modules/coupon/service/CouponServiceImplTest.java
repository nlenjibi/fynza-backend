...
class CouponServiceImplTest {
    ...
    class FindByIdTests {
        ...
        void findById_WhenCouponExists_ReturnsCoupon() {
            when(couponRepository.findByPublicId(couponId)).thenReturn(Optional.of(testCoupon));
        ...
        void findById_WhenCouponNotFound_ThrowsException() {
            when(couponRepository.findByPublicId(couponId)).thenReturn(Optional.empty());
